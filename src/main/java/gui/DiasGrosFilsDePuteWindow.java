...
public class DiasGrosFilsDePuteWindow {
	...
	private void initialize() {
		...
		checkBox.setBounds(284, 170, 189, 23);
		panel.add(checkBox);
		
		JCheckBox checkBox_1 = new JCheckBox("Separator line below header");
		checkBox_1.setSelected(true);
		checkBox_1.setBounds(284, 98, 189, 23);
		panel.add(checkBox_1);
		
		JSeparator separator = new JSeparator();
		separator.setBounds(93, 73, 397, 2);
		panel.add(separator);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(93, 138, 397, 2);
		panel.add(separator_1);
		
		JCheckBox checkBox_2 = new JCheckBox("Header");
		checkBox_2.setBounds(93, 98, 189, 23);
		panel.add(checkBox_2);
		
		JCheckBox checkBox_3 = new JCheckBox("Footer");
		checkBox_3.setBounds(93, 170, 189, 23);
		panel.add(checkBox_3);
		
		JLabel lblTextBelowTitle = new JLabel("Text below title");
		lblTextBelowTitle.setBounds(93, 237, 159, 19);
		panel.add(lblTextBelowTitle);
		
		JSeparator separator_2 = new JSeparator();
		separator_2.setBounds(93, 216, 397, 2);
		panel.add(separator_2);
		
		JSeparator separator_3 = new JSeparator();
		separator_3.setBounds(93, 324, 397, 2);
		panel.add(separator_3);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(238, 236, 243, 71);
